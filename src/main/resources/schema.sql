...
CREATE TABLE IF NOT EXISTS unites_ensemble (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    code TEXT UNIQUE NOT NULL,
    nom TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS notes (
    ...
    FOREIGN KEY (ue_id) REFERENCES unites_ensemble(id),
...
INSERT INTO unites_ensemble (code, nom, coefficient, credits, filiere_id, niveau_id, semestre_id) VALUES
...
('prof', '1234', 'Professeur', 'prof@univ-yaounde.cm', 'enseignant', 1),
('jury', '1234', 'Membre Jury', 'jury@univ-yaounde.cm', 'jury', 1);

INSERT INTO parametres (cle, valeur, description) VALUES
('seuil_ca', '50', 'Seuil minimum pour capacité'),
...
SELECT n.id, n.valeur, n.valeur_sur_bareme, n.statut, n.commentaire,
       n.date_saisie, n.date_validation, e.matricule,
...
SELECT e.id as etudiant_id, e.matricule, e.nom || ' ' || e.prenom as etudiant_nom_complet,
       ue.id as ue_id, ue.code as ue_code, ue.nom as ue_nom, ue.coefficient,
       s.id as semestre_id, s.numero as semestre, s.annee_academique,
       n_cc.valeur as note_cc, n_tp.valeur as note_tp,
       n_ee.valeur * 2 as note_ee_sur_40, n_ep.valeur * 2 as note_ep_sur_40,
       COALESCE(n_cc.valeur, 0) + COALESCE(n_ee.valeur * 2, 0) + COALESCE(n_ep.valeur * 2, 0) as total_sur_100,
       f.code as filiere, nv.code as niveau
FROM etudiants e
JOIN unites_ensemble ue ON ue.id = ue.id
...
SELECT ue.id as ue_id, ue.code as ue_code, ue.nom as ue_nom,
       s.id as semestre_id, s.annee_academique,
